...
import * as aot from './date';

const EXPECTED_EXPORTS = ['MinDate', 'MaxDate'] as const;
...
describe('aot/date', () => {
  ...
  it('should return a PropertyDecorator when called with valid args', () => {
    expect(typeof aot.MinDate(new Date())).toBe('function');
    expect(typeof aot.MaxDate(new Date())).toBe('function');
  });
