...
describe('@IsNumber boundary values', () => {
  ...
  it('-Infinity rejected', async () => { expect(await failCode(Dto, { v: -Infinity })).toBe('isNumber'); });
  it('0 passes', async () => { expect((await deserialize<any>(Dto, { v: 0 })).v).toBe(0); });
  it('-0 passes', async () => { expect((await deserialize<any>(Dto, { v: -0 })).v).toBe(-0); });
...
describe('@IsNumber({ allowNaN: true }) NaN allowed', () => {
  ...
  it('NaN passes', async () => { const r = await deserialize<any>(Dto, { v: NaN }); expect(isNaN(r.v)).toBe(true); });
});

describe('@IsNumber({ allowInfinity: true }) Infinity allowed', () => {
  class Dto { @Field(isNumber({ allowInfinity: true })) v!: number; }
  it('Infinity passes', async () => { expect((await deserialize<any>(Dto, { v: Infinity })).v).toBe(Infinity); });
  it('-Infinity passes', async () => { expect((await deserialize<any>(Dto, { v: -Infinity })).v).toBe(-Infinity); });
});

describe('@IsNumber({ maxDecimalPlaces: 2 }) decimal limit', () => {
  class Dto { @Field(isNumber({ maxDecimalPlaces: 2 })) v!: number; }
  it('2 decimal places passes', async () => { expect((await deserialize<any>(Dto, { v: 3.14 })).v).toBe(3.14); });
  it('integer passes', async () => { expect((await deserialize<any>(Dto, { v: 5 })).v).toBe(5); });
  it('3 decimal places rejected', async () => { expect(await failCode(Dto, { v: 3.141 })).toBe('isNumber'); });
  it('0 decimal places (integer) boundary', async () => { expect((await deserialize<any>(Dto, { v: 10 })).v).toBe(10); });
});
...
describe('@IsPositive boundary values', () => {
  ...
  it('0.001 passes', async () => { expect((await deserialize<any>(Dto, { v: 0.001 })).v).toBe(0.001); });
});
...
describe('@Min boundary values', () => {
  ...
  it('exactly 5 passes', async () => { expect((await deserialize<any>(Dto, { v: 5 })).v).toBe(5); });
  it('4.999 rejected', async () => { expect(await failCode(Dto, { v: 4.999 })).toBe('min'); });
  it('5.001 passes', async () => { expect((await deserialize<any>(Dto, { v: 5.001 })).v).toBe(5.001); });
});

describe('@Max boundary values', () => {
  class Dto { @Field(max(10)) v!: number; }
  it('exactly 10 passes', async () => { expect((await deserialize<any>(Dto, { v: 10 })).v).toBe(10); });
  it('10.001 rejected', async () => { expect(await failCode(Dto, { v: 10.001 })).toBe('max'); });
  it('9.999 passes', async () => { expect((await deserialize<any>(Dto, { v: 9.999 })).v).toBe(9.999); });
});
...
describe('@MinLength boundary values', () => {
  ...
  it('exactly 3 chars passes', async () => { expect((await deserialize<any>(Dto, { v: 'abc' })).v).toBe('abc'); });
...
describe('@MaxLength boundary values', () => {
  ...
  it('exactly 5 chars passes', async () => { expect((await deserialize<any>(Dto, { v: 'abcde' })).v).toBe('abcde'); });
...
describe('@IsPort boundary values', () => {
  ...
  it('"0" passes', async () => { expect((await deserialize<any>(Dto, { v: '0' })).v).toBe('0'); });
  it('"1" passes', async () => { expect((await deserialize<any>(Dto, { v: '1' })).v).toBe('1'); });
  it('"65535" passes', async () => { expect((await deserialize<any>(Dto, { v: '65535' })).v).toBe('65535'); });
...
describe('@IsLatitude boundary values', () => {
  ...
  it('"-90" passes', async () => { expect((await deserialize<any>(Dto, { v: '-90' })).v).toBe('-90'); });
  it('"90" passes', async () => { expect((await deserialize<any>(Dto, { v: '90' })).v).toBe('90'); });
...
describe('@IsLongitude boundary values', () => {
  ...
  it('"-180" passes', async () => { expect((await deserialize<any>(Dto, { v: '-180' })).v).toBe('-180'); });
  it('"180" passes', async () => { expect((await deserialize<any>(Dto, { v: '180' })).v).toBe('180'); });
...
describe('@IsMilitaryTime boundary values', () => {
  ...
  it('"00:00" passes', async () => { expect((await deserialize<any>(Dto, { v: '00:00' })).v).toBe('00:00'); });
  it('"23:59" passes', async () => { expect((await deserialize<any>(Dto, { v: '23:59' })).v).toBe('23:59'); });
...
describe('@ArrayMinSize boundary values', () => {
  ...
  it('exactly 2 passes', async () => { expect((await deserialize<any>(Dto, { v: [1, 2] })).v).toEqual([1, 2]); });
...
describe('@ArrayMaxSize boundary values', () => {
  ...
  it('exactly 3 passes', async () => { expect((await deserialize<any>(Dto, { v: [1, 2, 3] })).v).toEqual([1, 2, 3]); });
...
describe('@IsString with non-string types', () => {
  ...
  it('empty string passes', async () => { expect((await deserialize<any>(Dto, { v: '' })).v).toBe(''); });
});
